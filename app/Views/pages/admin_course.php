...
<body class="app sidebar-mini">
  ...
  <aside class="app-sidebar">
    ...
    <ul class="app-menu">
      ...
      <li><a class="app-menu__item active" href="admincourse"><i class="app-menu__icon fa fa-archive"></i><span class="app-menu__label">Course List</span></a></li>
  ...
  <main class="app-content">
    <div class="app-title">
      <div>
        <h1></i>Course List <button type="button" class="btn btn-md btn-primary noUnderlineCustom text-white" data-toggle="modal" data-target="#addModal">Add Course</h1>
        <p></p>
      </div>
      <ul class="app-breadcrumb breadcrumb side">
        <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
        <li class="breadcrumb-item active"><a href="#">Course List</a></li>
      </ul>
    </div>
    <div class="row">
      <div class="col-md-12">
                  ...
                  <?php foreach ($list_mata_pelajaran as $mata_pelajaran) { ?>
                    <tr>
                      ...
                      <td><button type="button" class="btn btn-md btn-primary fas fa-pencil-alt noUnderlineCustom text-white" data-toggle="modal" data-target="#editModal<?php echo $mata_pelajaran['id_mata_pelajaran'] ?>"></button>
                        <a href="<?php echo base_url('admindeletecourse?id='.$mata_pelajaran['id_mata_pelajaran']) ?>" type="button" class="btn btn-md btn-danger fas fa-trash noUnderlineCustom text-white"></a></td>
                    </tr>
                    <!-- Modal Form Option-->
                      ...
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            ...
                            <form action="<?php echo base_url('admineditcoursemodal') ?>" method="POST" enctype="multipart/form-data" method="POST" id="ModalForm">
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form action="<?php echo base_url('adminaddcourse') ?>" method="post" enctype="multipart/form-data" id="ModalForm">
