...
<body class="app sidebar-mini">
  ...
  <aside class="app-sidebar">
    ...
    <ul class="app-menu">
      ...
      <li><a class="app-menu__item active" href="adminteacher"><i class="app-menu__icon fa fa-black-tie"></i><span class="app-menu__label">Teacher List</span></a></li>
  ...
  <main class="app-content">
    <div class="app-title">
      <div>
        <h1></i>Teacher List</h1>
        <p></p>
      </div>
      <ul class="app-breadcrumb breadcrumb side">
        <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
        <li class="breadcrumb-item active"><a href="#">Teacher List</a></li>
      </ul>
    </div>
    <div class="row">
      <div class="col-md-12">
                ...
                <tbody>
                  ...
                  foreach ($list_guru as $guru) { ?>
                    <tr>
                      ...
                      <td><img src="<?php echo $guru['link_foto']; ?>" alt="" width="50"></td>
                      <td><button type="button" class="btn btn-md btn-primary fas fa-pencil-alt noUnderlineCustom text-white" data-toggle="modal" data-target="#editModal<?php echo $guru['id_user'] ?>"></button>
                        <a type="button" href="<?php echo base_url("admindeleteuserteacher?id=" . $guru['id_user'] . "&role=" . $id_role) ?>" class="btn btn-md btn-danger fas fa-trash noUnderlineCustom text-white"></a></td>
                    </tr>
                    <!-- Modal Form Option-->
                      ...
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            ...
                            <form action="<?php echo base_url('admineditgurumodal') ?>" method="POST" enctype="multipart/form-data" method="POST" id="ModalForm">
                              ...
                              <div class="form-group">
                                ...
                                <input type="date" name="birthdate_edit" class="form-control" id="birthdate" placeholder="Birthdate" value="<?php echo $guru['birthdate']; ?>" required>
                              </div>
