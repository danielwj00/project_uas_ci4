...
<body class="app sidebar-mini">
  ...
  <aside class="app-sidebar">
    ...
    <ul class="app-menu">
      ...
      <li><a class="app-menu__item active" href="adminclass"><i class="app-menu__icon fa fa-users"></i><span class="app-menu__label">Class List</span></a></li>
  ...
  <main class="app-content">
    <div class="app-title">
      <div>
        <h1></i>Class List <button type="button" class="btn btn-md btn-primary noUnderlineCustom text-white" data-toggle="modal" data-target="#addModal">Add Class</h1>
        <p></p>
      </div>
                  ...
                  <?php foreach ($list_kelas as $kelas) { ?>
                    <tr>
                      ...
                      <td><button type="button" class="btn btn-md btn-primary fas fa-pencil-alt noUnderlineCustom text-white" data-toggle="modal" data-target="#editModal<?php echo $kelas['id_kelas'] ?>"></button>
                        <a href="<?php echo base_url('admindeleteclass?id=' . $kelas['id_kelas']) ?>" type="button" class="btn btn-md btn-danger fas fa-trash noUnderlineCustom text-white"></a></td>
                    </tr>
                    <!-- Modal Form Option-->
                      ...
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            ...
                            <form action="<?php echo base_url('admineditclassmodal') ?>" method="POST" enctype="multipart/form-data" method="POST" id="ModalForm">
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form action="<?php echo base_url('adminaddclass') ?>" method="post" enctype="multipart/form-data" id="ModalForm">
            <!-- <input type="hidden" id="editId" value="terserah"> -->
