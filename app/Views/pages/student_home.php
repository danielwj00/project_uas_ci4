            ...
            <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-th-list"></i><span class="app-menu__label">Class</span><i class="treeview-indicator fa fa-angle-right"></i></a>
                <ul class="treeview-menu">
                    <?php foreach ($list_kelas as $kelas) { ?>
                        <li><a class="treeview-item" href="studentdata?id=<?php echo $kelas['id_kelas'] ?>"><i class="icon fa fa-circle-o"></i><?php echo $kelas['id_kelas'] . ' - ' . $kelas['name_kelas'] ?></a>
                        </li>
                    <?php } ?>
                </ul>
            </li>
    ...
    <main class="app-content">
        <div class="app-title">
            ...
            <ul class="app-breadcrumb breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="studenthome">Dashboard</a></li>
            </ul>
        </div>
        <div class="row">
            <?php foreach ($list_kelas as $kelas) { ?>
                <div class="col-md-12 col-lg-12">
                    <div id="hoverclick" onclick="location.href='studentdata?id=<?php echo $kelas['id_kelas'] ?>';" class="widget-small primary coloured-icon hoverclick"><i class="icon fa fa-archive fa-3x"></i>
                        <div class="info">
                            <h4><a href="studentdata?id=<?php echo $kelas['id_kelas'] ?>"><?php echo $kelas['id_kelas'] . ' - ' . $kelas['name_kelas'] ?></a></h4>
                            <p><b></b></p>
                        </div>
                    </div>
                </div>
